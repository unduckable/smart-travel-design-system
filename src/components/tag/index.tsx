...
export interface ITag extends VariantProps<typeof badgeClasses>, Omit<ButtonProps, "children">, TestProps {
  prefixIcon?: FC;
  suffixIcon?: FC;
  children?: ReactNode;
}
...
export const Tag: FC<ITag> = forwardRef<HTMLButtonElement, ITag>((props, ref) => {
